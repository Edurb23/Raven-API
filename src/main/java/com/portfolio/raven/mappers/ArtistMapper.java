...
public class ArtistMapper {
    ...
    public ArtistDetail toDetailDto(Artist artist){
        ...
        return new ArtistDetail(artist.getId(),artist.getName(), genreNames,artist.getBio(),java.util.List.copyOf(artist.getArtistImages()), artist.getCreated_at(), artist.getUpdate_at(), artist.getBannerImage());
    }
