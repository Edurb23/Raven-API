...
public class SecurityConfigurations {
    ...
    /**
     * Prevents Spring Boot from auto-registering SecurityFilter in the main servlet filter chain.
     * Without this, the filter runs before SecurityContextHolderFilter and the authentication
     * it sets gets overwritten, causing 401 on all authenticated requests.
     */
    @Bean
